 ...
 */
public class AdamWOptimizer extends AbstractOptimizer {
    ...
    public AdamWOptimizer(List<Tensor<?>> parameters, double learningRate, double beta1, double beta2, double epsilon) {
    ...
    private <T> void handle(Tensor<T> parameter) {
        ...
        Tensor<T> updated = parameter.sub(step);
